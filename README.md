...
+ 可以独立完成的动作						主语+**不及物动词**									   He **sleeps**.
+ 有一个动作的承受者                        主语+**单及物动词**+宾语                             He **likes** you.
+ 有两个动作承受者						    主语+**双及物动词**+间接宾语+直接宾语    He **teaches** you English.
+ 只有一个动作承受者(不同于2)        主语+**复杂及物动词**+宾语+(宾语)补语     He **considers** you smart.
+ 把这个词后面的信息赋予给前者     主语+**系动词**+(主语)补语(表语)                He **is** tall. He **looks** tall.
...
+ 谓语动词(~谓语)
+ 宾语
+ 宾语补语：补充宾语信息  He considers you **smart**.
+ 主语补语：补充主语信息  He is tall. He looks **tall**.
+ 定语：修饰主语和宾语   **The little white** rabbit ate **a large** carrot.
+ 状语：修饰谓语动词的词 The rabbit ate **quickly**.
+ 同位语：再把主语说一遍 Papa Rabbit, **an English teacher**, eat a carrot.
...
> 合称：TAM：时(Tense) 体(Aspect) 气(Mood) ，时间和状态成为时态，自由排列组合有16中时态
...
> 非谓语动词不受主语限制，不具备表达时间和人称的本领，非谓语动词简化了从句，使得句子言简意赅
...
> #### (2)虚拟语气：表达愿望，请求，建议，命令等

>**wish 希望(可能性小)**，而hope 希望(中性，不表达虚拟语气)，**would rather 宁愿**
>**demand 要求**，**suggest 建议**，**insist 坚持**，**order 命令**
>后面接的虚拟语气一律是**should + 动词原形**，和上方两个不太一样
...
>通常：+ing
>动词在此基础上改变拼写（方便发音或避免误解其实英语很多不规则，其实都有他不按规则的道理），如：
...
> 就是将现在进行时和现在完成时进行融合
>have的变位(**have/has**) + been(**be的过去分词,都是been**) + 动词的现在分词(be已经表示了过去分词)
...
> **will** + **be**(will已经算是变位过的助动词) + 动词的现在分词
...
> **will** + **have**(前面的will已经算是变位过了) + 动词的过去分词
